...
import su.uTa4u.specialforces.client.animations.TestEntityAnimation;
...
public class TestModel<T extends LivingEntity> extends HierarchicalModel<T> {
    ...
    public void setupAnim(T entity, float limbSpeed, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(((TestEntity) entity).idleAnimationState, TestEntityAnimation.IDLE, ageInTicks, 1.0f);
    }
